...
http_archive(
    name = "mediapipe",
    sha256 = "6730c853456d6590b55560fb682d8d961a4dfc0450f5219ef4fd553c1d7affdb",
    strip_prefix = "mediapipe-0.8.7.1",
    urls = ["https://github.com/google/mediapipe/archive/refs/tags/v0.8.7.1.zip"],
)
